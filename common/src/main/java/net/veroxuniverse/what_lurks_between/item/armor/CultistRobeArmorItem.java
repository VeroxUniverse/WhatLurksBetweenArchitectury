...
public class CultistRobeArmorItem extends ArmorItem implements ISanityModifier {
    public CultistRobeArmorItem(Holder<ArmorMaterial> holder, Type type, Properties properties) {
